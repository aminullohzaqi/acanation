<div class="sidenav shadow">
    ...
    <a href="pengumuman.php" class="active"><i class="fa fa-fw fa-bullhorn" aria-hidden="true"></i> Pengumuman</a>
...
<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a href="pengumuman.php"><i class="fa fa-fw fa-bullhorn" aria-hidden="true"></i> Pengumuman</a>
        </li>
        <li class="nav-item">
            <a href="../user/userlist.php"><i class="fa fa-fw fa-users" aria-hidden="true"></i> User</a>
        </li>
