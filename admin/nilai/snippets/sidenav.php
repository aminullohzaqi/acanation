<div class="sidenav shadow">
    ...
    <a href="editnilai.php" class="active"><i class="fa fa-fw fa-file-text" aria-hidden="true"></i> Nilai</a>
...
<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a href="editnilai.php"><i class="fa fa-fw fa-file-text" aria-hidden="true"></i> Nilai</a>
        </li>
        <li class="nav-item">
            <a href="../matkul/daftar.php"><i class="fa fa-fw fa-list-ul" aria-hidden="true"></i> Mata Kuliah</a>
        </li>
