                ...
                <div>
                    ...
                    <table id="tabeltambah">
                        <tr>
                            ...
                            <td><input type="hidden" name="id" id="" value="<?php echo $row_nilai["id"];?>"></td>
                        </tr>
                        <tr>
                            <th>Kehadiran</th>
                        ...
                        <tr>
                            <td><input type="submit" name="editnilai" value="Edit" class="btn btn-info" style="margin-top: 10px;"></td>
                        </tr>
                    </table>
                    </form>
                </div>
