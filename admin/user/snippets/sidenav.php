<div class="sidenav shadow">
    ...
    <a href="userlist.php" class="active"><i class="fa fa-fw fa-users" aria-hidden="true"></i> User</a>
...
<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a href="userlist.php"><i class="fa fa-fw fa-users" aria-hidden="true"></i> User</a>
        </li>
        <li class="nav-item">
            <a href="../logout.php"><i class="fa fa-fw fa-sign-out" aria-hidden="true"></i> Log Out</a>
        </li>
