<div class="sidenav shadow">
    ...
    <a href="profile.php" class="active"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Profile</a>
...
<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a href="profile.php"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Profile</a>
        </li>
        <li class="nav-item">
            <a href="../logout.php"><i class="fa fa-fw fa-sign-out" aria-hidden="true"></i> Log Out</a>
        </li>
