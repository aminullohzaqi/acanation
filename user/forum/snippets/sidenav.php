<div class="sidenav shadow">
    ...
    <a href="forumkelas.php" class="active"><i class="fa fa-fw fa-bullhorn" aria-hidden="true"></i> Forum</a>
...
<nav class="navbar fixed-top navbar-expand-md navbar-light bg-light shadow">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a href="forumkelas.php"><i class="fa fa-fw fa-bullhorn" aria-hidden="true"></i> Forum</a>
        </li>
        <li class="nav-item">
            <a href="../profile/profile.php"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Profile</a>
        </li>
